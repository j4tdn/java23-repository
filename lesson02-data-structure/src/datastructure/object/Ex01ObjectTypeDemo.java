...
public class Ex01ObjectTypeDemo {
	...
	public static void main(String[] args) {
		...
		// Khi mình in biến đó ra tự động gọi hàm toString trong Class Oject
		...
		// object type
		Item i1 = new Item();
		i1.id = 1; // gắn id=1 cho ô nhớ tại HEAP mà i1 đang trỏ đến
		i1.name = 'A'; // gán name = 'A'
		i1.salesPrice = 11;
		System.out.println("i1 --> " + i1); //bean.Item@77468bd9
