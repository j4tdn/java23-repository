...
public class Ex04Practice {
	 ...
	 * hiện tại là ngày thứ mấy(trong tuần), in ra ngày theo tiếng việt 5. In thông
	 * tin các ngày trong tháng, tuần hiện tại --> dd/MM/yyyy week_day 6. Đếm xem
	 * trong tháng có bao nhiêu ngày chủ nhật và in ra
	 */
	...
	public static void main(String[] args) {
		...
		// Locale.setDefault(new Locale("vi", "VN")); // sử dụng default locale cho tất
		// cả các Calendar khi getInstance
