...
public class Ex03MapPrinciple {
	...
	public static void main(String[] args) {
		...
		map.put(new Employee(3,"Manager 3",300d),
				List.of(new Employee(31,"E31",31d)) 
				);
		
		map.put(new Employee(1,"Manager 1",100d),
				List.of(new Employee(11,"E11",11d), 
						new Employee(12,"E12",12d))
				);
	...
	private static Map<Employee, List<Employee>> mockData(){
		...
		result.put(
				...
				List.of(new Employee(21,"E21",21d)) 
				);
