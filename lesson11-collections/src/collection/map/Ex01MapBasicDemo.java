...
public class Ex01MapBasicDemo {
	...
	/*
	  Bài toàn quản lý biển số xe, tỉnh thành tương ứng ở VN
	  --> List<VehicleModel>
	  --> Map<K,V>
	  	K: Mã số
	  	V: Thành phố
	  	...
	  	TreeMap
	  	+ Tự động sắp xếp các phần tử(Entry) trong map theo key tăng dần
	  	+ Key phải là con của Comparable<K>
