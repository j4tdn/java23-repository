...
public class Ex04Throw {
	...
	/*
	 ...
	 --> try / catch --> 100% khi nào cũng phải test xem bị exception không?
	 ...
	 Khi hàm xảy ra ngoại lệ do tham số truyền vào thì mình sẽ kiểm tra nếu tham số đó
	 không hợp lệ --> throw ra exception --> chỗ gọi hàm gây ra exception phải bắt lỗi đó
	 
	 Nếu ném mà chỗ gọi kh bắt --> dừng chương trình
	 
	 =====================================================================================
	 
	 Tại thời điểm compile, hàm divide ném ra exception Ari... 
