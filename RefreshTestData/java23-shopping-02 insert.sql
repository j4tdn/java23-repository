...
SELECT IF(C01_ITEM_ID > 10, C01_ITEM_ID - 10, C01_ITEM_ID) IRN_ID,
  ...
  FROM T01_ITEM;
  -- Error Code: 1305. FUNCTION java23_shopping.f_random does not exist
...
(6, 5, 345, 460, 3),
(9, 10, 656, 1300, 4);
  -- Error Code: 1452. Cannot add or update a child row: a foreign key constraint fails (`java23_shopping`.`t18_item_received_note_detail`, CONSTRAINT `FK_T18_T19` FOREIGN KEY (`C18_PROVIDER_ID`) REFERENCES `t19_provider` (`C19_PROVIDER_ID`))
...
-- Error Code: 1305. FUNCTION java23_shopping.cast_to_bit does not exist
...
(9, 'R9', '258369749', 'Địa chỉ 9', 1, '2024-04-18 08:10:20', 4, 6),(10, 'R10', '558369741', 'Địa chỉ 10', 2, '2024-04-18 08:10:20', 4, 9),
...
SELECT t06.C06_ORDER_ID ORDER_ID,
 ...
 WHERE t06.C06_ORDER_ID BETWEEN 11 AND 12
   AND t11.C11_ORDER_STATUS_ID BETWEEN 1 AND 7

-- Đơn hàng từ 13 --> Giao hàng thất bại(status 1,2,3,4,6)
-- Nhân viên 8
