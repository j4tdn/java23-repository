...
public class Ex04StreamFilter {
	...
	public static void main(String[] args) {
		...
		// 1. Tìm các phần tử chẵn trong danh sách
		generate("1. Tìm các phần tử chẵn trong danh sách ", elements.stream()
		...
		generate(
				"2.2 Tạo ra danh sách các phần tử không trùng nhau", 
				uniqueElements);
		...
		generate(
				"3. Lấy 3 phần tử đầu tiên trong danh sách", 
				elements.stream()
				.limit(3)
				.toList());
