...
public class Ex03OperationsF {
	...
	/*
	 * Mảng :fix-length --> Không thẻ thêm/xóa 1/n phần tử trong mảng -->Thực tế :
	 * yêu cầu thêm / xóa mình vẫn phải xử lý :Kết quả trả về mảng mới
	 * 
	 * Collection : list,set,map
	 * 
	 * Stream
	 * 
	 * Yêu cầu cho mảng số nguyên gồm n phần tử {1,5,8,2,20} Viết chương trình +Thêm
	 * phần tử bất kỳ vào vị trí thứ i trong mảng +Xóa phần tử tại ví trí thứ i
	 * trong mảng
	 * 
	 * Biết rằng i[0,n)
	 */
