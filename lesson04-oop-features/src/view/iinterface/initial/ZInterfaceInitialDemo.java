...
public class ZInterfaceInitialDemo {
	...
	public static void main(String[] args) {
		...
		// Cách 2: Anonumous class
		IntTest it2 = new IntTest() {
			
			@Override
			public boolean test(int number) {
				System.out.println("AnonumousClass#test");
				return number < 0;
			}
		...
		// mục đích cách này để viết ngắn gọn hơn!
		...
		/* anonymous function không thể dùng cho interface có nhiều hơn 1 hàm trừu tượng
		...
		*/
		...
		// sub operator --> anonymous function
