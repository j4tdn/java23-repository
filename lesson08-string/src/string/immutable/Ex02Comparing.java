...
public class Ex02Comparing {
	...
	/*
	 ...
	 + KDL đối tượng: sử dụng  ==, != so sánh giá trị của biến ở Stack
	                : 100% thừa kế từ clas Object(có hàm #equals)
	...
	public static void main(String[] args) {
		...
		System.out.println("========= Sử dụng toán tử '==' ===============");
		...
		System.out.println("(i1 eq i2) --> " + (i1.equals(i2))); // F T 
		System.out.println("(i3 eq i4) --> " + (i3.equals(i4))); // F F
		System.out.println("(i3 eq i5) --> " + (i3.equals(i5))); // F T
