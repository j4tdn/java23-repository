...
// Hầu hết dùng generic type, khi nào muốn generic là KDL chính nó --> ? void super
	
	
	// Cách 1 dùng generic type
	...
	//Cách 2 khi chưa biết KDL 
	private static void generated(List<?> elements) {
		System.out.println("Generate --> {");
		for(Object element:elements) {
			System.out.println("  + " +element);
		}
