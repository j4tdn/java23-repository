...
//		Item item2 = null; //item2 chưa trỏ ô nhớ nào tại HEAP
		Item item2 = new Item(2, "Item A2", LocalDate.of(2024, 6, 17));
		item2.setName("Item A22");
		System.out.println("item2 -->" + item2);

//		Có bao nhiêu đối tượng được tạo ra 

//		Đối tượng(ô nhớ trên vùng HEAP)
		Item item3 = item1; // no
		Integer i1 = 5; // yes
		Integer i2 = 7; // yes
		Integer i3 = new Integer(5); // yes
		Integer i4 = 7; // no vì có i2 = 7
		Car c1 = new Car(); // yes
		Car c2 = null; // no
		c2 = c1; // no
		c2 = new Car(); // yes
		...
		// Item i2 = new Item(); // H2
		// i1 = i2;
		// H1 k đc sử dụng,biến nảo trỏ đến sẽ tự động xóa

		// garbage collection ---> tự động đi xóa những ô nhớ k đc sử dụng
//		 cơ chế: Timing...
