...
public class Ex02Comparing {
	...
	/* 
	 ...
	 + KDL nguyên thủy: sử dụng các toán tử > < == >= <= !=
	 				  : so sánh giá trị ở stack
	 				  
	 + KDL đối tượng  : sử dụng  ==, != thì sẽ so sánh giá trị của biến ở stack (địa chỉ)
	 				  : 100% thừa kế từ class Object (có hàm #equals)
	 				    --> sử dụng hàm equals mặc định --> so sánh giá trị ở stack
	 				  : nếu muốn só sánh giá trị của đối tượng ở heap --> override hàm equals
	*/
	...
	public static void main(String[] args) {
		...
		// Thông thường sẽ sử dụng #equals để so sánh 2 đối tượng
