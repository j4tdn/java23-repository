...
public class ZPoTest {
	...
	public static void main(String[] args) {
		...
		/* 
		 + Biến KDL là Shape nó có thể new, 
		 nhận giá trị là Shape, Square, Circle là bất kỳ class nào con của Shape.
		 + Biến shape có tính chất đa hình trong đói tượng
		 ...
		 --> lúc compile tất cả các biến đều là KDL cha
		 	 --> dễ dàng gán giá tri, ép kiểu qua về giữa các biến
...
//		Circle: callS, paint, setBackground
//		Shape: callS, paint
	}
}
