...
public class ZInheritanceClassDemo {
	...
	/*
	  ...
	  + Liệt kê các sách thuộc nxb là Nhi Đồng
	...
	public static void main(String[] args) {
		...
		generate("Liệt kê các sách thuộc nxb Nhi Đông", findBooksByPublisher(books, "Nhi Dong"));
		generate(" Liệt kê các sách có giảm giá", findBooksWithDiscount(books));
	...
	private static Book[] findBooksWithDiscount(Book[] books) {
		...
		for (Book book: books) {
			...
			// book.getClass() --> lúc runtime book là ai (yêu cầu book khác null)
	...
	private static Book[] mockData() {
		return new Book[] {
				...
				new ReferenceBook(5, "RF5", 36d, "Da Nang", 3d),
				new TextBook(6, "TB6", 62d, "Nhi Dong", false, 10d),
				new TextBook(7, "TB7", 26d, "Da Nang", false, 0d),
		};
	}
