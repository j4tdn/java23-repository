...
public class Ex01BasicOopDemo {
	...
	public static void main(String[] args) {
		...
		// Yêu cầu: Tạo 3 đối tượng Car có KDL bất kỳ và in ra
		// Khi in biến có KDL đối tượng -> tự động gọi hàm tooString() của class Object
		//                              -> in ra tên package.class@hash
		
		// Nếu muốn in ra giá trị của ô nhớ ở HEAP mà biến đối tượng đang trỏ đến
		// --> override hàm tooString()
		
		Car c1= new Car("A", "A1", "Yellow", 2000d);
		Car c2= new Car("A", "A3", "Read", 4000d);
		Car c3= new Car("A", "A2", "Green", 3000d);
		...
		/*
		 FOP: data(no restriction, tất cả đều truy cập được, không phần quyền)
		 ...
		 1. Các thuộc tính trong class Car đang để access modifier là 'public'
		  ...
		  + sử dụng private attribute để class bên ngoài không thể truy cập trực tiếp thuộc 
		  	tính bên trong class
		  	
		  + nhưng trong thực tế mình vẫn muốn class bên ngoài có thể lẫy/cập nhật giá trị
		   	cho các thuộc tính bên trong class
		   	
		  VD: Công ty  :
		  	  Nhân viên:chứa thuộc tính private
