...
public class Ex02Comparing {
	 ...
	 * So sánh
	 * 
	 * + KDL nguyên thủy: sử dụng toán tử > < == >= <= != : so sánh giá trị ở stack
	 * 
	 * + KDL đối tượng: sử dụng ==, != so sánh giá trị của biến ở stack(địa chỉ) :
	 * 100% thừa kế từ class Object(có hàm #equals) --> sử dụng hàm equals mặc định
	 * --> so sánh giá trị ở stack : nếu muốn so sánh giá trị của đối tượng ở heap
	 * --> override hàm equals
	 * 
	 */
