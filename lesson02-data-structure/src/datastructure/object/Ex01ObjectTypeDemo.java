...
public class Ex01ObjectTypeDemo {
	...
	public static void main(String[] args) {
		...
		// new Item() --> tạo ra 1 ô nhớ để lưu trữ giá trị của 1 Item
		...
		i1.salesPrice = 11; // gán salesPrice=11 cho ô nhớ tại HEAP mà i1 đang trỏ đến
