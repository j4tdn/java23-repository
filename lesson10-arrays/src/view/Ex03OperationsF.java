...
public class Ex03OperationsF {
	...
	--> Thực tế: yêu cầu thêm/ xóa mình vãn phải xóa xử lý
	--> 	   : kết quả trà về mảng mới
	...
	public static void main(String[] args) {
		...
		int[] number = {1, 9, 5, 36, 33};
		
		int[] addedNumbers = add(number, 3, 18);
		
		System.out.println(
				"add(source, 3, 18) --> " + Arrays.toString(addedNumbers));
		int[] removedNumbers = remove(number, 2);
		System.out.println(
