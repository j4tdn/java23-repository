...
public class Ex02PassVariableViaMethod {
	...
	// Toán tử = dùng để COPY giá trị của VPhải gán cho VTrái
	// 			--> Hoạt động ở vùng nhớ STACK
	// Khi truyền giá trị qua hàm, giá trị ô nhớ ở STACK của biến đang truyền qua sẽ kh bao giờ thay đổi được
