...
public class Ex05CustomObjectType {
	...
	new Item(75, "Item A75", 28d, toDate("25.09.2024"), 102),
	...
	public static void main(String[] args) {
		...
		System.out.println("size afer remove --> " + items.size());
		...
		CollectionUtils.generateItems("item sorted (sales price desc)", items);
		...
		/*
			...
			Basic operations SOT: add, get, set, remove, removeIf, iterate , contains, sort, shuffle
		*/
	}
