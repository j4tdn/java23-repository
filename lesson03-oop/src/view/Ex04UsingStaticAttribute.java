...
public class Ex04UsingStaticAttribute {
	...
	public static void main(String[] args) {
		...
		CarAdv c4 = new CarAdv("A4", "White", 520d);
		...
		// --> các đối tượng dùng chung các giá trị
		// --> không nên lấy biến, gọi hàm setter để cập nhật giá trị
		...
		// --> có thể gọi thông qua class, đối tượng thuộc class
