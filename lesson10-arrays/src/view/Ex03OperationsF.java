...
public class Ex03OperationsF {
	...
	/*
	 ...
	 --> Thực tế: Yêu cầu thêm/xóa mình vẫn phải xử lí
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"remove(numbers, 2) --> " + Arrays.toString(removedNumbers));
	...
	private static int[] add(int[] source, int pos, int newValue) {
		...
		// Shift right 1 unit from addedPos
		// Dịch phải duyệt từ phải --> trái
		// Dịch trái duyệt từ trái --> phải
		
		// dịch a,b sang a+1, b+1
		// --> Duyệt từ b=1 > a
