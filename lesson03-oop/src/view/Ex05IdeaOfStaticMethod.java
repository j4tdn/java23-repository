...
//		System.out.println("o2 sum --> " + o2.sum(5, 7));

		
		System.out.println(" o sum == > " + Ex05IdeaOfStaticMethod.sum(6, 9));
		
		Ex05IdeaOfStaticMethod o1 = new Ex05IdeaOfStaticMethod("ab2424");
		System.out.println("o1 is number ==> "+ o1.isNumber());
		
		Ex05IdeaOfStaticMethod o2 = new Ex05IdeaOfStaticMethod("45678");
	...
	// Hầm sum phụ thuộc vào tham số truyền vào
	// 		Kh phụ thuộc vào đối tượng đang gọi == > static
