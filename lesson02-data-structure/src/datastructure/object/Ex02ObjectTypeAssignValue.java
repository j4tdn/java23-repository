...
public class Ex02ObjectTypeAssignValue {
	public static void main(String[] args) {
		...
		// Cách 1: cập nhật giá trị của các thuộc tính của ô nhớ HEAP hiện tại mà biến đang
		// trỏ đến
		i1.salesPrice = 99;
		System.err.println("i11 --> " +i1);
		System.out.println("i11 address = " + System.identityHashCode(i1));
		
		// Cách 2: cập nhật địa chỉ mà biến trỏ đến
		i1 = new Item(3, 'C', 33); // H3
		System.err.println("i12 --> " + i1);
		...
		System.out.println("i7 address = " + System.identityHashCode(i7));
