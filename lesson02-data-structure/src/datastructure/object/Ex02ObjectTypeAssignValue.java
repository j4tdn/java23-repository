...
public class Ex02ObjectTypeAssignValue {
	public static void main(String[] args) {
		...
		// Để cập nhập giá trị cho biến KDL nguyên thủy
		// Dùng toán tử =
		int a = 5;
		...
		// Cách 1: cập nhập giá trị các thuộc tính của ô nhớ (HEAP) hiện tại
		...
		// STACK: biến đối tượng --> địa chỉ ở vùng nhớ HEAP
	}
}
