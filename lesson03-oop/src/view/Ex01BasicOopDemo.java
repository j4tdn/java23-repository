...
public class Ex01BasicOopDemo {
	...
	public static void main(String[] args) {
		...
		/*
		  ...
		  Vấn đề 
		  1. Các thuộc tính trong class Cả đang để access modifier là 'public'
             --> dùng ở đâu cũng được		  
		 
		  + sử dụng private attribute để class bên ngoài ko thể truy cập trực tiếp thuộc tính
		  ...
		  VD: Công ty
		      ...
		      + setter --> cho phép cập nhật giá trị cuar thuộc tính private
