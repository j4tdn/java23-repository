...
public class Ex04Operator {
	public static void main(String[] args) {
		...
		// Toán tử == --> so sánh vế trái và vế phải kết quả trả về kiểu dữ liệu boolean(true,false)
		// VT = VP --> thực hiện VP trước , đc kết quả gán cho VT
		boolean e1 = (a == b);
		boolean e2 = (a * b == zz);
		boolean e3 = (a != zz);
		...
		System.out.println("\n====== Toán tử ++ -- =====\n");
		// Khi đặt toán tử ++ -- ở
		// trước(biến|biểu thức) -prefix : +-1 vào biến , biểu thức --> dùng giá trị mới đó
		...
		// && --> trả vể TRUE khi cả 2 biểu thức đều TRUE
