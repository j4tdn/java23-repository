...
-- Thêm khóa ngoại cho T01_PHONGBAN (bỏ ON DELETE SET NULL)
...
-- Bảng trung gian Nhân viên-Dự án
...
-- Chèn Quản lý tham gia dự án (5 dòng, thủ công)
