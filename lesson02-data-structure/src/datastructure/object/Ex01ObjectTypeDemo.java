...
//nếu 2 class khác package thì phải import class đó
import bean.Item;
...
public class Ex01ObjectTypeDemo {
	...
	public static void main(String[] args) {
		...
		// Dùng để chứ các hàm có sẵn của Java ví dụ là toString

		// new Item() -> tạo ra 1 đói tượng cho class Item (OOP)
		// new Item() -> tạo ra 1 ô nhớ để lưu trữ giá cho 1 Item
		// đối tượng(ô nhớ tại HEAP) --> luôn có đầy đủ thông tin của các thuộc tính bên trong class Item

		// object type - kiểu dữ liệu đối tượng
		Item i1 = new Item();
		i1.id = 1; // gán id=1 cho ô nhớ tại HEAP mà i1 đang trỏ đến
		i1.name = 'A'; // gán name = 'A' cho ô nhớ tại HEAP mà i1 đang trỏ đến
		i1.salesPrice = 11;
		System.out.println("i1 --> " + i1); // bean.Item@626b2d4a
		...
		// giá trị i3 luôn lưu trữ trong vùng nhớ Stack.
		// Item (gt) luôn lưu trữ trong vùng nhớ HEAP.
