...
public class Ex02Calendar {
	...
	// builder 	 parttern : LocalDate, LocalTime, LocalDateTime ...

	public static void main(String[] args) {
		
		// date day
		// c --> trả về thời gian thông tin hiện tại
		// month: 0-11
		// java.util.GregorianCalendar[time=1723642949375,areFieldsSet=true,areAllFieldsSet=true,lenient=true,
		// zone=sun.util.calendar.ZoneInfo[id="Asia/Saigon",offset=25200000,dstSavings=0,
		// 		useDaylight=false,transitions=10,lastRule=null],firstDayOfWeek=1,
		...
		// 		HOUR_OF_DAY=20,MINUTE=42,SECOND=29,MILLISECOND=375,ZONE_OFFSET=25200000,DST_OFFSET=0]
		...
		// String 		: Định dạng in giá trị của Date, Calendar ở dạng String(ko được dùng để tính toán)
		// 				: dd/MM/yyyy dd.MM.yyyy HH:mm:ss
		// 				: Chuyển đổi String, Date, Calender
