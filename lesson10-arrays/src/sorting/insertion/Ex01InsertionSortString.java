...
public class Ex01InsertionSortString {
	...
	/*
	  Dù là thuật toán sắp xếp gì chỉ cần strategy có tham số truyền vào là 2 phần tử trước, sau trong mảng
	...
	public static void main(String[] args) {
		String[] elements = { null, null,"a123",null,"z45",null, "c1",null,  "k6", "d28"};
