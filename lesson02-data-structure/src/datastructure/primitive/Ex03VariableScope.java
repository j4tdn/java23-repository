...
public class Ex03VariableScope {
	...
	/*
	 * 1 chương trình gồm 2 phần - Dữ liệu (Biến toàn cục) -->Cú pháp :[access
	 * modifier] [static] [final] return_type varible_name; -Chức năng -->Hầm,
	 * Phương thức -->Cú pháp :[access modifier] [static] [final] return_type
	 * varible_name(); -->Bên trong hàm, phương thức có thể khai báo biến cục bộ
