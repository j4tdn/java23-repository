...
//		s1 = "hello"; //một biến non static không thể dùng được bên trong 1 hàm static
		// vì không biết đối tượng nào cho s1
		s2 = "xin chào";
		test04();
//		test02();
	}
...
//		test02();
	...
	// muốn gọi đc phải có/biết đối tượng gọi non-static method/attribute
}
