...
public class ZPoTest {
	...
	public static void main(String[] args) {
		...
		// runtime: thực thi cấp phát vùng nhớ, chạt code
		
		// s1: lúc compile nó là Shape(KDL khai báo cho biến s1)
		// s1: lúc rumtime là đối tượng Circle(giá trị được gán vào cho biến s1)
		Shape s1 = new Circle();
		s1.calS();
		s1.paint();
		...
		/*
		  + Biến KDL là Shape nó có thể new, nhận giá trị là Shape, Circle, Square là bất
		  kỳ class nào con của Shape 
		  ...
		  --> Nếu Con c1 = new Cha()
		      ...
		      Thay vì đợi đến khi gọi không tìm thấy báo lỗi
