	 ...
	 So sánh: 
	  ...
	  + KDL đối tượng: sử dụng ==, != so sánh giá trị của biến ở stack
	           ...
	           ---> sử dụng hàm equals mặc định --> so sánh giá trị ở stack
	               : nếu muốn so sánh giá trị của đối tượng ở heap --> overide qua hàm euals
...
//    	         : overide equals từ object
    	   System.out.println("sử dụng hàm euquals 'overide' =====");
    	   System.out.println("i1 eq i2 -->" +(i1.equals(i2)));
    	   System.out.println("i3 eq i3 -->" +(i3.equals(i4)));
...
//    	   Thông thường sử dụng #equals để so sánh 2 đối tượng 
    	   ...
    	   System.out.println("s1==i2 --->" + (s1 == s2));//F
