...
public class Car {
	...
	// Khi gọi hàm khởi taoj
	// Tạo ra đối tượng trong class Car

	// Constructor with no parameter : hàm khởi tạo rỗng
	public Car() {
	}

	// Constructor with all parameters : hàm khởi tạo full tham số
