...
public class Ex02Comparing {
	...
	// So sánh chuỗi
		...
		public static void main(String[] args) {
			...
			System.out.println("i4==i5-->"+(i3==i5));
			...
			System.out.println("i4 eq i5-->"+(i3.equals(i5)));
			...
			System.out.println("(s1==s4)-->"+(s1==s4));// T --> Trùng địa chỉ 
			
			System.out.println("s1 eq s2-->"+(i1.equals(s2)));
			System.out.println("s1 eq s3-->"+(i3.equals(s3)));
