...
public class Ex03StringPractical {
	...
	public static void main(String[] args) {
		...
		String s3 = "123.456";
		System.out.println("kiểm tra chuỗi bắt đầu  . --> " + s3.startsWith("123"));
		System.out.println("kiểm tra chuỗi kết thúc . --> " + s3.startsWith("SGH"));
		
		System.out.println("thay thế s1 bằng s2 . --> " + s.replace(s1, s2));
		
		System.out.println("\s+" + s3);
		
		System.out.println("kiểm tra s1 có chauws s2 không . --> " + s1.contains(s2));
	}
