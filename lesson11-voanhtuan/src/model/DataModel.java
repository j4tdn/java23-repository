...
public class DataModel {
	...
	public static List<CD> mockCDs() {
		return List.of(new CD(1, "Pop", "Vo Anh Tuan", 10, 15.99), new CD(2, "Rock", "Rin Rin", 8, 12.50),
				new CD(3, "Jazz", "Yoasobi", 5, 20.00), new CD(4, "Classical", "Mr.Dam", 12, 18.75),
	...
	public static List<Word> generateWords() {
		return List.of(new Word("apple", "quả táo", "noun", "Một loại trái cây"),
	...
	public static Map<String, Double> mockSpending() {
		return new HashMap<>(Map.of("Ăn uống", 300000.0, "Giải trí", 600000.0, "Mua sắm quần áo", 700000.0,
				"Điện thoại", 1500000.0, "Đi lại", 200000.0, "Tiền thuê nhà", 500000.0));
	}
