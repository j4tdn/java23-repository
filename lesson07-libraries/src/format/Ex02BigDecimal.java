...
public class Ex02BigDecimal {
	...
	public static void main(String[] args) {
		...
		BigDecimal bdA23 = bd(a2).multiply(bd(a3)).setScale(2, RoundingMode.HALF_UP).multiply(bd(a1)).divide(bd(a4), 8,
				RoundingMode.HALF_UP);
		// nếu gọi hàm divide --> truyền vào ít nhất RoundMode hoặc scale hoặc
		// MathContext
